...
<details>
<summary><b>⚙️ 엔지니어링 하이라이트</b></summary>
<br>

- 하네스 엔지니어링 적용 — 주입된 의존성과 파일시스템 기반 상태 프로토콜을 갖춘 테스트 가능한 아키텍처
- Go CLI와 Unity Editor 간 크로스 프로세스 상태 조정을 위한 오케스트레이션 레이어
- 코드 정확성을 위한 Unity Mono 런타임 코딩 가이드라인 적용
- 크로스 플랫폼 릴리스 파이프라인(Linux/macOS/Windows, amd64/arm64)
